...
ValueError: Intentional failure for testing.
  File "/packages/ordeq-common/tests/resources/hooks/logger_hook_custom_level.py", line 16, in fail
    raise ValueError("Intentional failure for testing.")
  ...
  File "/packages/ordeq-common/tests/resources/hooks/logger_hook_custom_level.py", line 21, in <module>
    run(fail, hooks=[logger])
    ~~~^^^^^^^^^^^^^^^^^^^^^^
...
INFO	ordeq.runner	Running node "hello" in module "logger_hook_custom_level"
...
INFO	ordeq.runner	Running view "fail" in module "logger_hook_custom_level"
